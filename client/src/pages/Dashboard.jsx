  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Wrapper for buttons - showCreateResume - showUploadResume */}
            ...
            return (
              ...
              >
                ...
                <div onClick={e=> e.stopPropagation()}className="absolute top-1 right-1 group-hover:flex items-center hidden">
                  <TrashIcon 
                  onClick={()=> deleteResume(resume._id)}className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors" />
                  <PencilIcon 
                  onClick={()=> {setEditResumeId(resume._id); setTitle(resume.Title)}} className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors" />
                </div>
              </button>
            );
          })}
        ...
        {/* showCreateResume : if it is true open popup box to take input */}
        {showCreateResume && (
          <form
        ...
        {/* showUploadResume : if it is true open popup box to open uploadinput */}
        {showUploadResume && (
          <form
          ...
          {/* editResumeId : if it is true open popup box to editResumeTitle */}
        {editResumeId && (
          <form
            onSubmit={editTitle}
